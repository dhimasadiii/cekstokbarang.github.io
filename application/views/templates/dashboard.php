...
<body id="page-top">
    ...
    <div class="sidebar-brand-icon">
                ...
                <div class="sidebar-brand-text mx-3">Cek Stock Barang</div>
...
<div class="sidebar-heading">
    ...
    <!-- Nav Item - Dashboard -->
    <li class="nav-item">
             <a class="nav-link pb-0" href="<?=('https://forms.gle/Pi43mryCUdG3ZeL26'); ?>">
            ...
            <footer class="sticky-footer bg-light">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Form PP &copy; Aplikasi Untuk Mempermudah Pembelian Barang &bull; by Dhimas Adi</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
